<template>
  <div class="house-resource">
    ...
    <!--房源列表-->
    <ul class="house-list">
        <li v-for="(item,index) in cc.data.rentHouseList" :key="index" @click="scrollBottom">
            <div>
    ...
    <div class="choose">
        ...
        <a href="http://android.myapp.com/myapp/detail.htm?apkName=com.wukong.ua&ADTAG=mobile" class="download">下载APP，查看更多符合条件的房源</a>
        <p class="bgc"></p>
    </div>
  </div>
</template>
...
<style lang="less" scoped>
    @import "../../less/components/fallHouseResource.less";
</style>
